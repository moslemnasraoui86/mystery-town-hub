...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [{ title: "Terms of Service — Prime RolePlay" }] }),
  component: () => (
    <SiteLayout><section className="max-w-3xl mx-auto px-4 py-20 prose prose-invert">
      ...
      <p className="mt-6 text-muted-foreground">By creating an account or playing on Prime RolePlay you agree to follow our <a href="/rules" className="text-primary">rules</a> and code of conduct. Violations may result in suspension or permanent ban without refund.</p>
