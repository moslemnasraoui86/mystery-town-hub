...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Prime RolePlay" },
      { name: "description", content: "Get in touch with the Prime RolePlay team about questions, suggestions, partnerships, press or support. We read every message." },
      { property: "og:title", content: "Contact — Prime RolePlay" },
      { property: "og:description", content: "Reach the Prime RolePlay team — questions, suggestions, partnerships and press." },
      { property: "og:url", content: "https://prime-roleplay.lovable.app/contact" },
    ],
    links: [{ rel: "canonical", href: "https://prime-roleplay.lovable.app/contact" }],
  }),
