...
export const Route = createFileRoute("/partners")({
  head: () => ({ meta: [{ title: "Partners — Prime RolePlay" }, { name: "description", content: "The studios, hosts and creators powering Prime RolePlay." }]}),
  component: () => (
    <PageShell icon={HeartHandshake} title="Our" highlight="Partners" description="Without these folks, Prime RolePlay wouldn't exist.">
      <FeatureGrid items={[
